...
## 规则
| *.a                | !lib.a    | build/                | doc/*.txt                           | doc/**/*.txt                    |
|--------------------|-----------|-----------------------|-------------------------------------|---------------------------------|
| 所有以.a结尾的文件 | 除了lib.a | build目录下的所有文件 | 忽略doc/a.txt不包括doc/server/a.txt | doc目录下的所有以.txt结尾的文件 |
...
| git branch | git checkout 分支名 | git checkout -b 分支名 | git branch -d 分支名 | git branch -D 分支名 | git merge 分支名|
|------------|---------------------|------------------------|------------------------|------------------------|------------------------|
| 查看分支   | 切换分支            | 创建并切换分支         | 删除分支(分支之间相同) | 删除分支(不管想不相同) | 合并分支               |rch
